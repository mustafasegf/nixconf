  ...
  programs.neovim = {
    ...
    plugins =
      ...
      [
        ...
        {
          plugin = (
            pluginGit "lvimuser" "lsp-inlayhints.nvim" "master"
        ...
        {
          plugin = (
            pluginGit "nanotee" "sqls.nvim" "main" "sha256-jKFut6NZAf/eIeIkY7/2EsjsIhvZQKCKAJzeQ6XSr0s="
          );
          type = "lua";
        }
        ...
        {
          plugin = (
            pluginGit "mechatroner" "rainbow_csv" "master" "kNjEjIOyWViQ6hLyTwP9no7ZF0Iv/TGW0oXPlBM4eu4="
          );
        }
        {
          plugin = (
            pluginGit "kiyoon" "jupynium.nvim" "master" "HJrg+Jun4CxXKBgKEQGnF/EjyrXjJMwLexCCrnXA0+Y="
          );
          type = "lua";
        ...
        {
          plugin = (
            pluginGit "APZelos" "blamer.nvim" "master" "etLCmzOMi7xjYc43ZBqjPnj2gqrrSbmtcKdw6eZT8rM="
          );
          type = "lua";
        }
        {
        ...
        {
          plugin = (
            pluginGit "VonHeikemen" "fine-cmdline.nvim" "main" "w9wwjClkOWk3wCgEiZIFLZRJ/gAfX38x2LnVRaelKD8="
          );
          type = "lua";
          config = ''
        ...
        {
          plugin = (
            pluginGit "marilari88" "twoslash-queries.nvim" "main" "QlzfWZg8v0N19SmwPquWjCc/nsWAeOLeri5iMXOIueA="
          );
          type = "lua";
        }

        # MDX syntax highlight
        (pluginGit "davidmh" "mdx.nvim" "main" "0mwzqmqi386qhjbc9jr1p5c50mzm127lssxfa4nkzxpr654xi8s1")
